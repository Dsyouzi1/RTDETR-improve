...
def check_font(font="Arial.ttf"):
    ...
    file = Path("/home/Newdisk1/ds/code/ultralytics_solo/ultralytics/utils/Arial.ttf")
    if file.exists():
        return file
...
def check_amp(model):
    ...
    try:
        ...
        assert amp_allclose(YOLO("/home/Newdisk1/ds/code/ultralytics_solo/yolov8n.pt"), im)
